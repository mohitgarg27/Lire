...
public class IndexingThread extends Thread {
    ...
    public void run() 
    {
        ...
        try {
            ...
            java.util.ArrayList<java.lang.String> images = getAllImages(new java.io.File(parent.textfieldIndexDir.getText()), true);
            if (images == null) 
            {
            ...
            ParallelIndexer pin =new ParallelIndexer(8, parent.textfieldIndexName.getText(), parent.textfieldIndexDir.getText(), create)
            {
                    @Override
